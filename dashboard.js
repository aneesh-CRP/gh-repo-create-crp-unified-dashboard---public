    ...
    if (subjectsUrl) {
      try {
        ...
        if (sRows && sRows.length > 0) {
          ...
          var _subStatusUp = {
            'Enrolled':'ENROLLED','Screen Fail':'SCREEN_FAIL','Screening':'SCREENING',
            'Scheduled V1':'SCHEDULED_V1','Prequalified':'PREQUALIFIED',
            'No Show/Cancelled V1':'SCHEDULED_V1_NO_SHOW_CANCELLED',
            'Discontinued':'DISCONTINUED','Completed':'COMPLETED','Interested':'INTERESTED'
          };
