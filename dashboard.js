...
function showVisitReadiness(idx) {
  ...
  rows += '<tr><td style="font-weight:600">Records in CRIO</td><td>' + dot(r.crioOk) + ' ' + escapeHTML(mr.records_in_crio || 'Not set') + '</td></tr>';
  rows += '<tr><td style="font-weight:600">PI Approval</td><td>' + dot(r.piOk) + ' ' + escapeHTML(mr.investigator_approval || 'Not set') + '</td></tr>';
