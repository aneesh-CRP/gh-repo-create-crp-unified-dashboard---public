...
function renderCoordWorkloadBalance() {
  ...
  var html = '<div style="font-size:11px;color:#64748b;margin-bottom:8px;font-weight:600;">Upcoming Visit Distribution (all scheduled visits)</div>';
