...
function processLiveData(allRows, legacyCancels, auditLog) {
  ...
  // NOTE: includes rescheduled + no-shows — repeat cancellers are a risk signal
  // even if they rebooked, and no-shows are an engagement risk signal
...
function showJourneyFunnelDetail(key) {
  ...
  if (key === 'total_leads') {
    // Show all referrals + FB CRM leads
