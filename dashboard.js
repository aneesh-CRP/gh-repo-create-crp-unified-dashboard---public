...
function renderAll() {
  ...
  var _adjCancel = (DATA.allCancels||[]).filter(function(r){return !_patientRecovered(r.name,r.study);}).length;
  var _adjNoShow = (DATA.noShows||[]).filter(function(r){return !_patientRecovered(r.name,r.study);}).length;
  var _adjWithdrew = (DATA.withdrawals||[]).filter(function(r){return !_patientRecovered(r.name,r.study);}).length;
  var _adjSF = (DATA.screenFails||[]).filter(function(r){return !_patientRecovered(r.name,r.study);}).length;
