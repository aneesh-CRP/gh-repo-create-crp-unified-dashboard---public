...
function fetchActionRequiredData() {
  ...
  // Batch fetch all 4 feeds in one request (reduces HTTP overhead)
  fetch(base + '?feed=batch&feeds=comments,documentSummary,visitTodos,regulatory&format=json')
