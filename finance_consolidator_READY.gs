...
// to the "CRP Finance Master" Google Sheet — one tab per report.
//
...
// Your CRP Finance Master sheet ID
var MASTER_SHEET_ID = '1UNnuWHIkoiB0Xl4qJ7T0Ynmf2L6Mce-IOAOB032wCME';
...
function setupDailyTrigger() {
  ...
  // Create new daily trigger at 7:30 AM EDT
